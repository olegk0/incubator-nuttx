...
static void stm32_ltdc_periphconfig(void)
{
  ...
  reginfo("configured RCC_PLLCFGR=%08x\n", getreg32(STM32_RCC_PLLCFGR));

  /* Configure  */

//  reginfo("configured RCC_PLL3FRACR=%08x\n", getreg32(STM32_RCC_PLL3FRACR));

  /* Configure  */

  reginfo("configured RCC_PLL3DIVR=%08x\n", getreg32(STM32_RCC_PLL3DIVR));
...
#ifdef CONFIG_STM32H7_LTDC_BACKLIGHT
